...
<body>
        ...
        <div class="grid">
            ...
            <nav class="navigation">
                <ul class="navigation__list navigation__list--inline">
                    ...
                    <li class="navigation__item"><a href="#" class="navigation__link"> Jouer </a></li>
                    <li class="navigation__item"><a href="#" class="navigation__link">Info Jeux</a></li>
                    <li class="navigation__item"><a href="#" class="navigation__link">Classement Général</a></li>
                    <li class="navigation__item connexion"><a href="#" class="navigation__link">Se connecter</a></li>
                </ul>
            </nav>
    ...
    <footer>
        ...
        <p>Conctacté nous avec nos réseaux
            ...
            <a href=""><img href="./images/logo_facebook.png"></a>
            <a href=""><img href="./images/logo_github.png"></a>
            <a href=""><img href="./images/logo_ph.png"></a>
        </p>
    </footer>
</body>
</html>
